...
namespace Eclipse_System_Analysis
{
    class EclipseInfoGenerator
    {
        ...
        public string CURRENT_DESKTOP_PATH = Environment.GetFolderPath(System.Environment.SpecialFolder.DesktopDirectory);
        ...
        //After call to ValidateBackupsFolder, if return True, which means we find a valid
        //backup folder, then we have these objects created and available under RECOV_USERS_LOADED as EclipseObjects -
        //The Key is the path to the backup file, and the value is the original associated ini.
        ...
        //Step 1 - Get all the ini's from MainDir5, 
        //these objects become part of the "CURRENT_LOADED_INI_ECL_OBJS" that can be accessed.
        //Each object can have "INI_JOB_FOLDER" that you can plug into BUILD_JOB_INFO_LIST
